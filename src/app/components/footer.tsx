        ...
        <div className="w-full bg-[#4338CA] bottom-0 left-0 absolute ">
           <div className="m-5 ">
            <div>
             ...
             <p className="text-[14px] text-[#FAFAFA] ">© 2024 Movie Z. All Rights Reserved.</p>
            ...
            <div className="flex pt-6">
              <div>
                ...
                <div className="flex items-center pt-4">
                  ...
                  <div className="pl-3">
                    <p className="text-[#FAFAFA] text-[14px] font-medium">Email:</p>
                    <p className="text-[#FAFAFA] text-[14px] ">support@movieZ.com</p>
                  </div>
                ...
                <div className="flex items-center  pt-6">
                  ...
                  <div className="pl-3">
                    <p className="text-[#FAFAFA] text-[14px] font-medium">Phone:</p>
                    <p className="text-[#FAFAFA] text-[14px] ">+976 (11) 123-4567</p>
                  </div>
